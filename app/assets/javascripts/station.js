...
$(document).on('ready page:load', function() {
	...
	$("#cs1, #cs2").on("input", function(){
		$(".station").remove();
		$("#bikepng").animate({width: "60%"}, 500)
	});
